...
MODEL_ARGS="model_name=$MODEL,base_url=$BASE_URL,generation_parameters={max_new_tokens:32768,temperature:1.0,top_p:1.0,returns_logits:false,reasoning_effort:$THINKING_EFFORT},use_chat_template=true,tp_size=$NUM_GPUS"
