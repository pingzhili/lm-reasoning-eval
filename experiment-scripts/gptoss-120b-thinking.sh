...
MODEL_ARGS="model_name=$MODEL,generation_parameters={max_new_tokens:32768,temperature:1.0,top_p:1.0,returns_logits:false,thinking_effort:$THINKING_EFFORT},use_chat_template=true,tp_size=$NUM_GPUS"
